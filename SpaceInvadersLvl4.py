...
root = Tk()
root.title ('Space Invaders Level 4')
...
staticPen.pendown()
staticPen.write('Level 4', False, align= "center", font=("krungthep", 25))
staticPen.penup()
...
introPen.write("Level 4", False, align="center", font=("krungthep", 40))
time.sleep(2)
introPen.clear()
