...
root = Tk()
root.title ('Space Invaders Level 3')
...
staticPen.pendown()
staticPen.write('Level 3', False, align= "center", font=("krungthep", 25))
staticPen.penup()
...
introPen.write("Level 3", False, align="center", font=("krungthep", 40))
time.sleep(2)
introPen.clear()
