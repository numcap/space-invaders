...
root = Tk()
root.title ('Space Invaders Level 1')
...
staticPen.pendown()
staticPen.write('Level 1', False, align= "center", font=("krungthep", 25))
staticPen.penup()
...
introPen.write("The Space Invaders Are Here", False, align="center", font=("krungthep", 40))
time.sleep(2)
introPen.undo()
introPen.write("They Came To Invade Your Ship", False, align="center", font=("krungthep", 40))
time.sleep(2)
introPen.undo()
introPen.write("Destroy Them!", False, align="center", font=("krungthep", 40))
time.sleep(2)
introPen.undo()
introPen.write("Level 1", False, align="center", font=("krungthep", 40))
time.sleep(2)
introPen.clear()
