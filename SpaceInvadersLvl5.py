...
root = Tk()
root.title ('Space Invaders Level 5')
...
staticPen.pendown()
staticPen.write('Level 5', False, align= "center", font=("krungthep", 25))
staticPen.penup()
...
introPen.write("Level 5", False, align="center", font=("krungthep", 40))
time.sleep(2)
introPen.clear()
...
while True:
    ...
    for count in range(maxAims):
        ...
        if score == 10:
            ...
            introPen.color("white")
            introPen.setposition(0,0)
            introPen.write("Congratulations", False, align="center", font=("krungthep", 40))
            time.sleep(2)
            introPen.undo()
            introPen.write("You Have Deafeted", False, align="center", font=("krungthep", 40))
            time.sleep(2)
            introPen.undo()
            introPen.write("The Space Invaders", False, align="center", font=("krungthep", 40))
            time.sleep(3)
            root.destroy()
            root.quit()
            import MainMenu
